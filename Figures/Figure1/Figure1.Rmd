...
gb_coords <- '../../figure_outputs/hg38_refseq_NR_gene_bodies.bed'
...
#read in coordinates
gene_data <- read.table(gb_coords,sep=',')
...
write.table(gene_data_nr,paste0(outputs,"GR_gene_counts.txt"),quote = FALSE,sep = '\t')
...
A549_wt_1vs0dex <- lfcShrink(dds, contrast = c('group', 'A5491', 'A5490'), type = 'normal')
A549_wt_100vs0dex <- lfcShrink(dds, contrast = c('group', 'A549100', 'A5490'), type = 'normal')
U2OS_wt_1vs0dex <- lfcShrink(dds, contrast = c('group', 'U2OS1', 'U2OS0'), type = 'normal')
U2OS_wt_100vs0dex <- lfcShrink(dds, contrast = c('group', 'U2OS100', 'U2OS0'), type = 'normal')
...
write.table(gene_DESeq, paste0(outputs,'gene_DESeq_analysis.txt'), quote = F, sep = '\t')
```
